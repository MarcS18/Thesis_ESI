...
Flexible: For use with multiple energy calculation methods
"""
...
def main():
    ...
    outfile = f'Activation_Energies_Pyr_{method}.csv'
    ...
    for ident in tqdm(identifiers):
        ...
        # Else extract energy data
            ...
            if energy_data['sm_e'] == 'NaN' or energy_data['sm_e'] is None:
                ...
                sm = sm_g + gbl.dmf_common['pyrrolidinone'][method] + gbl.dmf_common['iodobenzene'][method] + \
                    2 * gbl.dmf_common['caesium'][method] + gbl.dmf_common['carbonate'][method]
                product = sm_g + gbl.dmf_common['N_phenyl_pyrrolidinone'][method] + \
                    2 * gbl.dmf_common['caesium'][method] + gbl.dmf_common['iodide'][method] + \
                    gbl.dmf_common['hydrogen_carbonate'][method]
            ...
            if energy_data['le_e'] == 'NaN' or energy_data['le_e'] is None:
                ...
                le = le_g + 2 * gbl.dmf_common['caesium'][method] + gbl.dmf_common['iodide'][method] + \
                    gbl.dmf_common['iodobenzene'][method] + gbl.dmf_common['hydrogen_carbonate'][method]
            ...
            if energy_data['tsoa_e'] == 'NaN' or energy_data['tsoa_e'] is None:
                ...
                tsoa = tsoa_g + 2 * gbl.dmf_common['caesium'][method] + gbl.dmf_common['iodide'][method] + \
                    gbl.dmf_common['hydrogen_carbonate'][method]
            ...
            if energy_data['tssig_e'] == 'NaN' or energy_data['tssig_e'] is None:
                ...
                tssig = tssig_g + 2 * gbl.dmf_common['caesium'][method] + gbl.dmf_common['iodide'][method] + \
                    gbl.dmf_common['hydrogen_carbonate'][method]
