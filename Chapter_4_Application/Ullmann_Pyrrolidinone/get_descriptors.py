...
def main():
    ...
    for ident in tqdm(identifiers):
        ...
        x_energy_file = f'./{x_file_prefix}/{x_file_prefix}_orca_energy.out'
        try:
        ...
        nu_energy_file = f'./{nu_file_prefix}/{nu_file_prefix}_orca_energy.out'
        ...
        tsoa_energy_file = f'./{tsoa_file_prefix}/{tsoa_file_prefix}_orca_energy.out'
        ...
        tssig_energy_file = f'./{tssig_file_prefix}/{tssig_file_prefix}_orca_energy.out'
