...
class KeywordsSet:
    ...
    def __init__(self, opt=None, opt_ts=None,
                 hess=None, optts_block=''):
        """
        ...
        Keyword Arguments:
            ...
            opt (list(str)): List of keywords for a optimisation
            opt_ts (list(str)): List of keywords for a optimisation
            hess (list(str)): List of keywords for a optimisation
